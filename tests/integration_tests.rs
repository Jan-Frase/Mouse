...
#[test]
fn test_perft_01() {
    let state = State::new_from_fen("8/1n2k3/5n1n/2n5/4N3/2N5/1N2KN2/8 w - - 0 1");
...
#[test]
fn test_perft_02() {
    let state = State::new_from_fen("4k3/pppppppp/8/8/8/8/PPPPPPPP/4K3 w - - 0 1");
    let nodes = perft(&state, 4);
...
#[test]
fn test_perft_03() {
    let state = State::new_from_fen("4k3/ppp5/7p/8/8/8/PPP5/4K3 w - - 0 1");
...
#[test]
fn test_perft_05() {
    let state = State::new_from_fen("7k/3p4/8/2P5/8/8/8/7K b - - 0 1");
...
#[test]
fn test_perft_06() {
    let state = State::new_from_fen("7k/8/8/8/8/2K5/2P5/8 w - - 0 1");
...
#[test]
fn test_perft_07() {
    let state = State::new_from_fen("8/3P1k2/8/8/8/8/8/7K b - - 0 1");
...
#[test]
fn test_perft_08() {
    let state = State::new_from_fen("8/1ppP1k2/1n6/3P2P1/8/8/8/7K b - - 0 1");
...
#[test]
fn test_perft_09() {
    let state = State::new_from_fen("7k/P7/8/8/8/8/8/7K w - - 0 1");
...
#[test]
fn test_perft_10() {
    let state = State::new_from_fen("6k1/8/8/8/8/8/8/Q1R1B2K b - - 0 1");
...
#[test]
fn test_perft_11() {
    let state = State::new_from_fen("6k1/6Q1/8/8/8/8/8/2R1B2K b - - 0 1");
...
fn test_perft_13() {
    ...
    let state = State::new_from_fen("6k1/8/8/8/8/8/8/R3K2R w KQ - 0 1");
...
fn test_perft_14() {
    ...
    let state = State::new_from_fen("2r2rk1/8/8/8/8/8/8/R3K2R w KQ - 0 1");
...
fn test_perft_15() {
    ...
    let state = State::new_from_fen("2r2rk1/8/8/8/8/8/8/R1B1K1NR w KQ - 0 1");
...
fn test_perft_17() {
    // test if basic castling moves get made and unmade correctly
    let state = State::new_from_fen("r5k1/8/8/8/8/8/8/R3K2R w KQ - 0 1");
